  ...
  return (
    <Card className="bg-black text-white border-2 border-white shadow-[0_10px_20px_rgba(255,255,255,0.1)] max-w-md mx-auto font-mono">
      <CardContent className="p-6">
        ...
        <div className="space-y-4">
          <div className="bg-gray-900 p-4 border-2 border-white shadow-[inset_0_2px_4px_rgba(255,255,255,0.1)]">
            ...
            <div className="flex justify-between items-center mt-2">
              <div className="relative w-1/2">
                <Input
                  className="bg-black border-2 border-white text-lg w-full pl-3 pr-10 py-2 shadow-[inset_0_4px_6px_rgba(255,255,255,0.1)] focus:shadow-[inset_0_6px_8px_rgba(255,255,255,0.2)] transition-all duration-200"
                  placeholder="0"
                  type="number"
                  step="any"
                  min="0"
                ...
                />
                <button
                  className="absolute inset-y-0 right-0 flex items-center pr-3 text-[#FFC700] hover:text-yellow-300 text-xs font-semibold"
              ...
              <Select onValueChange={handleToken0Select} disabled={!isConnected} value={token0}>
                <SelectTrigger className="w-[120px] bg-black border-2 border-white shadow-[0_4px_0_rgba(255,255,255,1)] hover:shadow-[0_2px_0_rgba(255,255,255,1)] active:shadow-none transition-all duration-200 transform active:translate-y-1">
                  <SelectValue>
          ...
          <div className="bg-gray-900 p-4 border-2 border-white shadow-[inset_0_2px_4px_rgba(255,255,255,0.1)]">
            ...
            <div className="flex justify-between items-center mt-2">
              <div className="relative w-1/2">
                <Input
                  className="bg-black border-2 border-white text-lg w-full pl-3 pr-10 py-2 shadow-[inset_0_4px_6px_rgba(255,255,255,0.1)] focus:shadow-[inset_0_6px_8px_rgba(255,255,255,0.2)] transition-all duration-200 read-only:bg-gray-900 read-only:cursor-default read-only:focus:shadow-[inset_0_4px_6px_rgba(255,255,255,0.1)]"
                  placeholder="0"
                  type="number"
                  value={token1Amount}
                  readOnly
        ...
        <div className="flex justify-between items-center text-sm text-gray-400 mt-4 mb-2">
        ...
        <Button 
          className="w-full mt-2 bg-[#FFC700] text-black border-2 border-white shadow-[0_4px_0_rgba(255,255,255,1)] hover:shadow-[0_2px_0_rgba(255,255,255,1)] active:shadow-none transition-all duration-200 transform active:translate-y-1"
